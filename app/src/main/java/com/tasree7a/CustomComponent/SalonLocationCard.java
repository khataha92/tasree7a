...
public class SalonLocationCard extends FrameLayout {
    ...
    private int maxTranslation = UIUtils.dpToPx(150);
    ...
    public void setupData() {
        ...
        findViewById(R.id.view_to_click).setOnClickListener(v -> {
...
//                FragmentManager.showSalonLocationFragment(locationModel.getSalonModel());
    ...
    public void init() {
        hotelMap = findViewById(R.id.salon_map);
        ...
        UIUtils.loadUrlIntoMap(getContext(), url, hotelMap);
    }
