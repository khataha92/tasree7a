...
public class CustomButton extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        buttonText = rootView.findViewById(R.id.button_tv);
        buttonIcon = rootView.findViewById(R.id.button_iv);
        loader = rootView.findViewById(R.id.loader);
//        loader.setProgressDrawable(new ColorDrawable(R.drawable.progressbar_drawable));
...
//            setButtonBackgroundAndStrock(backgroundColor, strokeColor, GradientDrawable.RECTANGLE, radius);
    ...
    public void setOnClickListener(final OnClickListener onClickListener) {
        OnClickListener incubatingOnClick = v -> {
    ...
    public void setButtonHeight(int val) {
        findViewById(R.id.button_container).getLayoutParams().height = val;
    }
